...
AGENT_DISPLAY_NAME="Calendar Oauth A2A Agent - April 2026"
AGENT_DESCRIPTION="A2A Agent that manages your calendar."
AUTH_ID="projects/305610648548/locations/global/authorizations/calendar-oauth-auth-7"

# IMPORTANT: You must update this URL with the actual Cloud Run URL output from deploy_a2a_server.sh
AGENT_URL="https://a2a-oauth-calendar-ypnjpxxv7q-uc.a.run.app"
