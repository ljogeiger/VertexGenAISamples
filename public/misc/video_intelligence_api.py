...
gcs_uri = "gs://sample_data_1293/Premier-trimmed-cropped.mp4"
output_uri = "gs://sample_data_1293/output - {}.json".format(time.time())

video_client = videointelligence.VideoIntelligenceServiceClient.from_service_account_file(
    "/Users/lukasgeiger/Downloads/geminipro1-5-df7e2a6e713f.json")
