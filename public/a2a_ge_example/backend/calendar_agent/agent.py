...
# Disable OpenTelemetry to prevent asyncio threading variable crash
os.environ["OTEL_SDK_DISABLED"] = "true"

from dotenv import load_dotenv

# Ensure we load the parent backend .env for local `adk web` runs
load_dotenv("/Users/lukasgeiger/Desktop/VertexGenAISamples/public/a2a/backend/.env")
...
USER_ID = 'TEST_USER'
STAGING_BUCKET = os.environ.get("STAGING_BUCKET", "gs://calendar_agent_bucket")
