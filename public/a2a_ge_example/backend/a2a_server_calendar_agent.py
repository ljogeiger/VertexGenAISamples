...
from calendar_agent.oauth_server import app as oauth_app
...
async def create_sqlalchemy_engine(
    ...
    try:
        async with engine.begin() as conn:
            ...
            oauth_tokens_table = sqlalchemy.Table(
                "oauth_tokens",
                metadata,
            ...
            logger.info("✅ Successfully connected to the database and ensured 'oauth_tokens' table exists.")
